...
class Autoencoder(nn.Module):
    ...
    def __init__(self,embed_dim,flat_dim,kernel_size=5,input_channels=1): 
        ...
        self.decoder = nn.Sequential(
            ...
            nn.BatchNorm1d(64),
            nn.Upsample(scale_factor=2),
            nn.ConvTranspose1d(in_channels=64, out_channels=64, kernel_size=self.kernel_size, padding=3),
            nn.ReLU(),
            nn.BatchNorm1d(64),
            nn.Upsample(scale_factor=2),
            ...
            nn.BatchNorm1d(32),
            nn.Upsample(scale_factor=2),
            nn.ConvTranspose1d(in_channels=32, out_channels=16, kernel_size=self.kernel_size, padding=2),
            nn.ReLU(),
            nn.BatchNorm1d(16),
            nn.Upsample(scale_factor=2),
